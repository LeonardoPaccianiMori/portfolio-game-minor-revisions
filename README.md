...
record correction passed; integration pending**.
...
pending. This does not accept Step 3 or authorize Step 4. Each later step needs
its own plan, local test or result review, correction cycle, and explicit
acceptance. The

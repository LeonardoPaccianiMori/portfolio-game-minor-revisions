...
| Departures | Archive area that keeps the 12 most recent ending cards in chronological order. It shows no empty slots, expected-run count, or completion percentage. |
...
| Ending card | Compact local post-campaign record of the career label, paper, evidence, integrity, fatigue, people consequences, and citations. It appears in Departures. |
...
| Research Status | Player-opened panel for evidence, Elena's paper confidence, integrity, working trust, route feedback, and reasons for material state changes. |
...
| Service pass-through | Optional Gabriel-linked short route between shared desks and imaging. It opens after the relevant supportive choice, with Working-or-better Gabriel trust and no breach. It is never required. |

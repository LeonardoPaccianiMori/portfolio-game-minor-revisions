...
| MR-REQ-SAVE-001 | Use one validated IndexedDB active save, backup, migration, recovery, Archive, local-data clear, and no save cookie or expiry. Preserve the S05 safe-save, pre-scene, post-result, Save and Quit, load, and recap boundaries. | 10, 11, implementation S05 | MR-TEST-SAVE-001, MR-S05-REC-001 | MR-WP-02 |
| MR-REQ-TECH-001 | Use the approved strict TypeScript, Vite, direct Three.js, local dependency, deterministic rules, manuscript and reviewer state, forecast/reason validation, build-specific string validation, no-network architecture, S02 module graph, one-way imports, single application coordinator, state ownership, specialist resource ownership, lifecycle, request queue, frame loop, failure boundaries, exact S03 campaign-state contract, exact S04 rule contracts, and exact S05 scheduler, event, cutscene-coordination, and fault contracts. | 11, implementation S01–S05 | MR-TEST-TECH-001, MR-S02-FIX-001–010, MR-S03-FIX-001, MR-S03-REJ-001–005, MR-S04-CMD-001, MR-S04-REJ-001, MR-S04-FLT-001, MR-S05-SCH-001, MR-S05-FLT-001 | MR-WP-00 |

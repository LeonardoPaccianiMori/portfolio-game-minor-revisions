...
| MR-REQ-LOOP-001 | Implement the approved action costs, `MR-ACT-BREAK`, five queue lines, six internal reactions, five exit responses, 64-period calendar, pressure profiles, universal warnings, exact S04 atomic energy, surcharge and push-through rules, crash, and no pre-W16 global game over. Preserve the R03-updated economy fixture results until Leonardo approves a later balance change. | 02, 07, 12, implementation S04 | MR-TEST-EXP-001, MR-TEST-NARR-001, MR-S04-CMD-001 | MR-WP-01 |
...
| MR-REQ-END-001 | Resolve routes, paper state, integrity, fatigue, public-withdrawal variant, unchosen route, and all five relationship consequences into the approved irreversible final choice and 29 ending modules through the exact S04 route, PIIM, module, and relationship tie rules. | 08, 12, implementation S04 | MR-TEST-END-001, MR-S04-CMD-001 | MR-WP-01 |
...
| MR-REQ-TECH-001 | Use the approved strict TypeScript, Vite, direct Three.js, local dependency, deterministic rules, manuscript and reviewer state, forecast/reason validation, build-specific string validation, no-network architecture, S02 module graph, one-way imports, single application coordinator, state ownership, specialist resource ownership, lifecycle, request queue, frame loop, failure boundaries, exact S03 campaign-state contract, and exact S04 command, result, effect, validation, rejection, fault, atomic-rule, and deterministic-variation contracts. | 11, implementation S01–S04 | MR-TEST-TECH-001, MR-S02-FIX-001–010, MR-S03-FIX-001, MR-S03-REJ-001–005, MR-S04-CMD-001, MR-S04-REJ-001, MR-S04-FLT-001 | MR-WP-00 |

...
| MR-REQ-CHAR-001 | Implement the ten optional character scenes, non-numeric five-segment trust presentation, five once-per-campaign support results, credit rules, concern visibility and response, Camila call, and exact route conditions. | 03, 05, 07, 10, 12 | MR-TEST-CHAR-001 | MR-WP-08 |
...
| MR-REQ-UI-001 | Implement semantic HUD, Research Status, desk hub, the fixed manuscript-board positions and factual requirements panel, menus, costs, projected-band reasons without exact probabilities, raw-first analysis, stop consequences, confirmations, text keys, and no objective-arrow rule. | 02, 10, 12 | MR-TEST-UI-001 | MR-WP-05 |
...
| MR-REQ-TECH-001 | Use the approved strict TypeScript, Vite, direct Three.js, local dependency, deterministic rules, manuscript and reviewer state, forecast/reason validation, build-specific string validation, and no-network architecture. | 11 | MR-TEST-TECH-001 | MR-WP-00 |

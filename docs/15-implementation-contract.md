...
| MR-REQ-WORLD-001 | Implement one continuous accessible floor with approved stations, anchors, act states, navigation limits, and no player trapping. | 06, 11 | MR-TEST-WORLD-001 | MR-WP-03 |
...
| MR-REQ-UI-001 | Implement semantic HUD, Research Status, desk hub, menus, costs, confirmations, text keys, and no objective-arrow rule. | 02, 10, 12 | MR-TEST-UI-001 | MR-WP-05 |
...
| MR-REQ-CONTENT-002 | Ship the approved full and fallback content counts, dependencies, expiry, effects, records, citations, and environmental items. | 06, 08, 12 | MR-TEST-CONT-001 | MR-WP-08 |

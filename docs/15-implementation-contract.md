...
| MR-REQ-TECH-001 | Use the approved strict TypeScript, Vite, direct Three.js, local dependency, deterministic rules, manuscript and reviewer state, forecast/reason validation, build-specific string validation, no-network architecture, S02 module graph, one-way imports, single application coordinator, state ownership, specialist resource ownership, lifecycle, request queue, frame loop, failure boundaries, exact S03 campaign-state contract, exact S04 rule contracts, exact S05 scheduler, event, cutscene-coordination, and fault contracts, exact S06 content package, profile, validation, and view contracts, exact S07 persistence interface and transaction contracts, and exact S08 spatial, movement, target, focus, projection, and fault contracts. | 11, implementation S01–S08 | MR-TEST-TECH-001, MR-S02-FIX-001–010, MR-S03-FIX-001, MR-S03-REJ-001–005, MR-S04-CMD-001, MR-S04-REJ-001, MR-S04-FLT-001, MR-S05-SCH-001, MR-S05-FLT-001, MR-S06-VAL-001, MR-S06-FLT-001, MR-S07-SAV-001, MR-S07-FLT-001, MR-S08-MOV-001, MR-S08-TGT-001, MR-S08-WLD-001, MR-S08-FLT-001 | MR-WP-00 |

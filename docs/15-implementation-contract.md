...
|---|---|---|---|---|
| MR-REQ-VISION-001 | Preserve bitterly comic, accessible institutional satire through active play and plausible bureaucratic accretion; keep science, architecture, and human stakes grounded; do not add prohibited content. | 01 | MR-TEST-CONT-001 | MR-WP-08 |

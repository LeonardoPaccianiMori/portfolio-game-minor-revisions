...
| MR-REQ-TECH-001 | Use the approved strict TypeScript, Vite, direct Three.js, local dependency, deterministic rules, manuscript and reviewer state, forecast/reason validation, build-specific string validation, no-network architecture, S02 module graph, one-way imports, single application coordinator, state ownership, specialist resource ownership, lifecycle, request queue, frame loop, failure boundaries, and exact S03 campaign-state, validation, canonical JSON, identifier, and permanent-history contracts. | 11, implementation S01–S03 | MR-TEST-TECH-001, MR-S02-FIX-001–010, MR-S03-FIX-001, MR-S03-REJ-001–005 | MR-WP-00 |

...
Status: **S01–S10 resolved; S11 issue group active; no issue silently resolved**
...
| MR-IMP-OPEN-011 | S11 | Exact compatibility detection, graphics-profile values, CPU/GPU and memory budgets, download budgets, profiling method, diagnostics format, privacy boundary, and response to failed measurements | Open; next | Pending `specs/11-browser-performance-and-diagnostics.md` |
...
The current active group is `MR-IMP-OPEN-011`.

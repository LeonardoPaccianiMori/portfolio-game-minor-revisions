...
Status: **S01–S05 resolved; S06 issue group active; no issue silently resolved**
...
| MR-IMP-OPEN-006 | S06 | Exact authored-data file split, object schemas, cross-references, string-file contract, validation order, content versioning, and full/fallback/slice build selection | Open; next | Pending `specs/06-content-data-and-build-profiles.md` |
...
The current active group is `MR-IMP-OPEN-006`.

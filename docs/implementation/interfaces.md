...
Status: **planned interface inventory; no interface frozen**
...
|---|---|---|---|---|---|---|
| MR-IF-001 | Runtime bootstrap and application lifecycle | S01–S02 | All runtime modules, UI, tests | Not started | Pending S02 | Start, stop, compatibility failure, and teardown fixtures |

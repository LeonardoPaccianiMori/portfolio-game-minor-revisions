...
| MR-IF-002 | `CampaignState` and serializable domain types                     | S03–S07      | Rules, scheduler, content, persistence, UI, cutscenes, tests                                                | Frozen | `v6`; owner: `rules`; `v1`–`v5` superseded                                                                                                                                         | MR-IMP-DEC-310 and the reviewed Step5 contract; runtime acceptance is not inferred from approval.                                                                                                                                                                                                                                                                                            |
| MR-IF-003 | Rule command, rejection, effect, and transition result            | S04–S06      | Application, interaction, UI, scheduler, audio, cutscenes, persistence coordination, tests                  | Frozen | `v3`; owner: `rules`; `v1`–`v2` superseded                                                                                                                                         | MR-IMP-DEC-310 and the reviewed Step5 contract; runtime acceptance is not inferred from approval.                                                                                                                                                                                                                                                                                            |
...
| MR-IF-005 | Safe-point scheduler and event queue                              | S05–S07      | Application, rules, narrative, cutscenes, persistence, UI, content validation, tests                        | Frozen | `v3`; owner: `rules`; `v1`–`v2` superseded                                                                                                                                         | MR-IMP-DEC-310 and the reviewed Step5 contract; runtime acceptance is not inferred from approval.                                                                                                                                                                                                                                                                                            |
| MR-IF-006 | Authored content objects, references, strings, and build profiles | S06–S07      | Rules, scheduler, application bootstrap, persistence, UI, audio, cutscenes, content tests                   | Frozen | `v3`; owner: `content`; `v1`–`v2` superseded                                                                                                                                       | MR-IMP-DEC-310 and the reviewed Step5 contract; runtime acceptance is not inferred from approval.                                                                                                                                                                                                                                                                                            |
...
| MR-IF-010 | UI view model and semantic action dispatch                        | S09          | Rules, persistence, input, content, captions, menus, tests                                                  | Frozen | `v3`; projection and semantic-screen owner: `ui`; validation and dispatch owner: `application`; v1–v2 superseded                                                                   | MR-IMP-DEC-310 and the reviewed Step5 contract; runtime acceptance is not inferred from approval.                                                                                                                                                                                                                                                                                            |
...
## 2026-09-08 Step5 freeze and supersession

MR-IMP-DEC-310 freezes these successors for Step5. The exact shapes, operations, errors, copies and view projections are in `analysis/step-05-content-contract.md`, with section20 taking precedence over an earlier conflicting candidate sketch.

| Interface | Frozen successor | Supersedes | Exact change                                                                                                                                                                                                           | Owner and consumers                                                                                                  |
| --------- | ---------------- | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| MR-IF-002 | v6               | v5         | Split the opening event identity to `MR-EVT-CLARIFIED`; permit selected tutorial receipts; add `validateCampaignStateAgainstContent` and the five exact evaluation-slice dormant-state IDs. Campaign schema remains 2. | Rules owns it; application/content connected validation consumes it.                                                 |
| MR-IF-003 | v3               | v2         | Add `tutorialShown`, first-analysis milestone completion, exact facility/Gabriel correlated room results and verified-checkpoint ownership. Retain one command-owned action cost.                                      | Rules owns it; application, content and UI consume it.                                                               |
| MR-IF-005 | v3               | v2         | Add the exact facility/Gabriel event creation, queued/eligible/active route guard, result, expiry and fallback lifecycle.                                                                                              | Scheduler owns it; rules, application, content and UI consume it.                                                    |
| MR-IF-006 | v3               | v2         | Freeze source/built/profile/result/issue/view contracts, 97-item/213-key slice, 144 laser rows, 26 audio roles, 29 interface items, content version 1.1.0 and phase-profile behavior.                                  | Content owns it; rules, application, bootstrap, UI, persistence and build tooling consume restricted views/metadata. |

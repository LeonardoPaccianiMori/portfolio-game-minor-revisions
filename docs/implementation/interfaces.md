...
`MR-IF-001` through `MR-IF-015` are frozen `v1` through their owning S02–S12
specifications, the S13 ownership and phase boundary, the connected S12
fixture and acceptance contract, and the S14 cross-interface audit. The S13
staged-content correction is included in frozen `MR-IF-006`.
...
signature or source file. Gate 1 and separate Gate-2 approval remain required.

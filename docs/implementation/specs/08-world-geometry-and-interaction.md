...
with frozen `v2` to define its exact creation input. Saved semantic world
facts, spatial plans, anchors, movement, targeting, projection, and no-trap
contracts remain unchanged and unimplemented.

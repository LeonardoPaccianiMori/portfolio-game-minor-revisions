...
Status: **Development restarted on 2026-09-10 under opencode. B00–B10, R00–R07, S00–S14, and the frozen interfaces remain authoritative; legacy implementation records are historical. The replacement pathway R1–R63 is documented; no step is authorized until its own exact plan is approved.**
...
| `15-implementation-contract.md`                 | Agent handoff                                                 | B10 and S13–S14 plus incremental workflow documented   | Development restarted 2026-09-10; pathway R1–R63 documented; the R1 plan needs approval.                                 |
...
| `implementation/roadmap.md`                     | Technical-specification programme                             | S00–S14, Gate 1, and development governance documented | Steps 1–5 accepted as legacy history; frozen contracts remain revisable only through approved evidence-led supersession. |
...
| `implementation/development-roadmap.md`         | Incremental implementation sequence (R1–R63; legacy appendix) | Replacement pathway documented 2026-09-10              | Prepare the exact R1 plan for approval.                                                                                  |
...
| `implementation/step-records/`                  | Merged step plan, execution, review, and acceptance records   | MR-SR-000 records the migration; contract in S13       | One record per approved step before work starts.                                                                         |
...
- Development pathway: **R1–R63 documented**; no new step is authorized until its own exact plan is approved.
- Vertical slice, fallback, and full-game acceptance: **blocked**; the
  pathway is documented but no step is authorized or executed.
...
- **Approved decision set:** content uses stable `MR-...` identifiers,
  ...
  Evaluation is private to Leonardo and the coding agent. It uses the approved internal
  ...
  a 90-day private critical-fix period. The approved origin and automatic
  post-review pushes are recorded in AGENTS.md. A later public source release uses
  ...
  branch rules, step records, integration rules, and definition of done
...
replacement pathway R1–R63 is documented and the R1 plan needs approval**.
...
history; the replacement pathway renumbers and re-sequences them as R1–R63, and

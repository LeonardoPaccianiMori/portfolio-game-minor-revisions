...
This block defines the story spine, the clock, the act structure, the PI and
colleague arcs, the fixed events, the endings, the tone curve, and the allowed
meta moments. Character names and voices are chosen in Block A5.

## Story spine

- The PI's project is a fragile soil-microbiome result that appears to suppress
  a plant pathogen.
- The PI spins it toward a high-impact claim: a microbiome therapy for crops.
- The paper's scientific question is the MacGuffin. The story is about people
  and the system that consumes them.
...
- The PhD student, whose work the player can protect or steal: the player's
  responsibility and possible victim.
- The departing postdoc, the player's possible future: solidarity or
  competition.
- Names, voices, and deeper arcs are chosen in Block A5.
...
- Act I: funny.
- Act II: bitter.
- Act III: cold, with absurd flashes.
- Running gags pay off instead of new gags being introduced late.
- The institution's cheerful voice becomes chilling rather than louder.
...
- Character names, voices, arcs, and the player character (A5).
- World, department, and presentation (A6).
- Content budget and evaluation (A7).
- Epilogue writing (content phase).
